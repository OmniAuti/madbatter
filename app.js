  ...
  for (const modalOpens of modalOpen) {
    modalOpens.addEventListener("click", function (e) {
      if (e.target.parentElement.classList.contains("menu-item-container")) {
        ...
        if (
          e.target.parentElement.classList.contains("menu-item-container") &&
          e.target.parentElement.classList.contains("egg")
        ) {
          ...
          e.target.parentElement.classList.contains("menu-item-container") &&
          e.target.parentElement.classList.contains("potatoes")
        ) {
          sidesModal.style.display = "block";
          ...
          e.target.parentElement.classList.contains("menu-item-container") &&
          e.target.parentElement.classList.contains("meat")
        ) {
          sidesModal.style.display = "block";
          ...
          e.target.parentElement.classList.contains("menu-item-container") &&
          e.target.parentElement.classList.contains("avacado-toast")
        ) {
          sidesModal.style.display = "block";
          ...
          e.target.parentElement.classList.contains("menu-item-container") &&
          e.target.parentElement.classList.contains("almond-milk")
        ) {
          ...
          e.target.parentElement.classList.contains("menu-item-container") &&
          e.target.parentElement.classList.contains("milk")
        ) {
          drinkModal.style.display = "block";
          ...
          e.target.parentElement.classList.contains("menu-item-container") &&
          e.target.parentElement.classList.contains("juice")
        ) {
          drinkModal.style.display = "block";
          ...
          e.target.parentElement.classList.contains("menu-item-container") &&
          e.target.parentElement.classList.contains("tea")
        ) {
          drinkModal.style.display = "block";
          ...
          e.target.parentElement.classList.contains("menu-item-container") &&
          e.target.parentElement.classList.contains("coffee")
        ) {
          drinkModal.style.display = "block";
          ...
          e.target.parentElement.classList.contains("menu-item-container") &&
          e.target.parentElement.classList.contains("water")
        ) {
          drinkModal.style.display = "block";
...
function updateModalPrice() {
  for (const checkboxes of checkbox) {
    checkboxes.addEventListener("click", function (e) {
      ...
      let price =
        e.target.parentElement.lastElementChild.firstElementChild.textContent;
...
function moveToCheckout() {
  ...
  for (const itemsInfo of cartItems) {
    ...
    const cartN =
      itemsInfo.lastElementChild.previousElementSibling.firstElementChild
        .innerText;
    const cartA =
      itemsInfo.lastElementChild.previousElementSibling.lastElementChild
        .innerText;
